...
/* Slide manifest — main.jsx glob-imports this default export from every
 * slides-part*.jsx, concatenates them in filename order, and auto-prepends
 * a position number (NN) to each label. Labels here describe the slide;
 * never write the leading number yourself. */
export default [
